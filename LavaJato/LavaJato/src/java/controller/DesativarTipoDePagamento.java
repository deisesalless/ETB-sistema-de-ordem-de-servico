...
@WebServlet(name = "DesativarTipoDePagamento", urlPatterns = {"/DesativarTipoDePagamento"})
public class DesativarTipoDePagamento extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Desativar Tipo De Pagamento</title>");
            out.println("</head>");
            out.println("<body>");
