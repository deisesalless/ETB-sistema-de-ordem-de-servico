...
@WebServlet(name = "AtivarFormaDePagamento", urlPatterns = {"/AtivarFormaDePagamento"})
public class AtivarFormaDePagamento extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Ativar Forma De Pagamento</title>");
            out.println("</head>");
            out.println("<body>");
            ...
            boolean status = Boolean.parseBoolean(request.getParameter("status"));
                ...
                try {
                    ...
                    formaDePagamentoBD.ativar(formaDePagamento);
